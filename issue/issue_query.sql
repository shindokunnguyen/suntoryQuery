...
issue.issue_finish_date = DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y-%m-%d' ),
issue.issue_finish_datetime = DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y-%m-%d %H:%i:%s' ),
issue.issue_finish_time = DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%H:%i' ),
issue.issue_finish_month = DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%m' ),
issue.issue_finish_year = DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y' ),
issue.issue_finish_year_month = DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y/%m' ),
issue.issue_finish_dept_code = issue_temp.COMP_DEPT_CODE,
issue.issue_finish_dept_name = issue_temp.COMP_DEPT_NAME,
issue.issue_finish_person_code = issue_temp.COMP_USER_CODE,
issue.issue_finish_person_name = issue_temp.COMP_USER_NAME,
...
issue.issue_status_code =
IF
	( IFNULL( issue_temp.COMP_DATE_TIME, '' ) = '', '2', '7' ),
issue.issue_status_name =
IF
	( IFNULL( issue_temp.COMP_DATE_TIME, '' ) = '', '対応中', '完了' ),
...
DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y-%m-%d' ),
DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y-%m-%d %H:%i:%s' ),
DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%H:%i' ),
DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%m' ),
DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y' ),
DATE_FORMAT( issue_temp.COMP_DATE_TIME, '%Y/%m' ),
issue_temp.COMP_DEPT_CODE,
issue_temp.COMP_DEPT_NAME,
issue_temp.COMP_USER_CODE,
issue_temp.COMP_USER_NAME,
...
IF( IFNULL( issue_temp.COMP_DATE_TIME, '' ) = '', '2', '7' ),
IF( IFNULL( issue_temp.COMP_DATE_TIME, '' ) = '', '対応中', '完了' ),
